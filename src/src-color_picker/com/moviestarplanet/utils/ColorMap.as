package com.moviestarplanet.utils
{
   ...
   public class ColorMap implements IColorReader
   {
      ...
      public static function SetColorsOnMovieClip(param1:MovieClip, param2:int, param3:String = null, param4:Object = null, param5:Boolean = false) : void
      {
         if(param1 == null)
         {
            return;
         ...
         var _loc5_:Array;
         if((_loc5_ = param1.colorMap as Array) == null)
         {
            _loc5_ = ColorMap.CreateColorMap(param1);
            param1.colorMap = _loc5_;
         }
		 if(param4 == null) {
			 _loc5_ = CreateColorMapFromColorScheme(param1, Utilities.createColorMapFromColorString(param3));
		 } else {
			 _loc5_ = CreateColorMapFromColorScheme(param1, Utilities.createColorMapFromColorStringUsingObject(param3, param4));
		 }
      ...
      public static function parseColorSchemeString(param1:String) : Object
      {
         ...
         {
            if((_loc5_ = _loc4_.split("=")).length == 2)
            {
      ...
      private static function parseColorCodeString(param1:String) : Array
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            if((_loc5_ = _loc4_.split(",")).length >= 1)
            {
      ...
      public static function SetColorsOnColorMap(param1:String, param2:Array) : void
      {
         ...
         {
            _loc3_ = param1.split(",");
            _loc4_ = Math.min(_loc3_.length,param2.length);
            _loc5_ = 0;
            while(_loc5_ < _loc4_)
            {
      ...
      public static function createMobileColorMapStr(param1:Array) : String
      {
         ...
         var _loc3_:* = "defaultcolor=defaultcolor," + _loc2_.defaultcolor.color + ",label;";
      ...
      public static function ApplyColorAtIndex(param1:String, param2:MovieClip, param3:int, param4:String) : void
      {
         ...
         var _loc7_:uint = 0;
         var _loc5_:Array;
         if((_loc5_ = param2.colorMap as Array) == null)
         {
         ...
         {
            if((_loc6_ = _loc5_[param3]).color != "skincolor")
            {
               _loc6_.color = param1;
            }
            _loc7_ = parseInt(param4);
      ...
      private static function CreateColorMapFromColorScheme(param1:MovieClip, param2:Object) : Array
      {
         ...
         var _loc5_:Array;
         if((_loc5_ = param2["colors"] as Array) == null)
         {
            _loc5_ = [];
         }
         var _loc6_:Array;
         if((_loc6_ = param2["nocolor"] as Array) == null)
         {
            _loc6_ = [];
         }
         ...
         var _loc10_:Object;
         if((_loc10_ = param2["defaultcolor"]) != null)
         {
            if((_loc12_ = _loc10_["label"] as String) == null || _loc12_.length == 0)
            {
               throw new Error("Undefined label in the defaultcolor");
            }
            if((_loc13_ = _loc10_["color"] as String) == null || _loc13_.length == 0)
            {
         ...
         var _loc11_:Array;
         if((_loc11_ = param2["colors"] as Array) != null)
         {
            _loc17_ = 0;
            for each(_loc18_ in _loc11_)
            {
               _loc19_ = _loc18_["label"] as String;
               if((_loc20_ = _loc18_["color"] as String) == null || _loc20_.length == 0)
               {
      ...
      public static function FindInstances(param1:DisplayObject, param2:Object, param3:Array, param4:Array, param5:int = 0) : Boolean
      {
         ...
         if((_loc7_ = param1 as DisplayObjectContainer) != null)
         {
            _loc9_ = new Array();
            _loc10_ = _loc7_.numChildren;
            _loc11_ = 0;
            while(_loc11_ < _loc10_)
            {
               if(_loc12_ = _loc7_.getChildAt(_loc11_))
               {
                  if((_loc13_ = FindInstances(_loc12_,param2,param3,param4,param5 + 1)) == false)
                  {
                     _loc9_.push(_loc12_);
                  }
               }
         ...
         if(IsValidUserDefinedInstanceName(_loc8_))
         {
            ...
            {
               if((_loc18_ = _loc17_["instances"]) != null && _loc18_.length > 0)
               {
                  if(_loc19_ = _loc18_.indexOf(_loc8_) != -1)
                  {
                     (_loc20_ = param4[_loc15_] as Array).push(param1);
                     _loc6_ = true;
                     break;
                  }
               }
            ...
            if(_loc6_ == false)
            {
               ...
               else if((_loc21_ = param2["nocolor"] as Array) != null)
               {
                  if(_loc22_ = _loc21_.indexOf(_loc8_) != -1)
                  {
                     _loc6_ = true;
                  }
               }
      ...
      public function applyColorScheme(param1:MovieClip, param2:String, param3:String) : void
      {
         ...
         else if(param1.hasOwnProperty("colorscheme") && param1.colorscheme != null)
         {
            ColorMap.SetColorsOnMovieClip(param1,0,param3,false);
         }
      }
      ...
      public function extractColorScheme(param1:MovieClip, param2:String) : Object
      {
         ...
         if(param1.hasOwnProperty("colorscheme") && param1.colorscheme != null)
         {
